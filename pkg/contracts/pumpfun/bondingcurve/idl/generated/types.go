...
type BondingCurve struct {
	...
	IsCashbackCoin       bool               `json:"isCashbackCoin"`
}
...
type ClaimCashbackEvent struct {
	...
	Timestamp           int64              `json:"timestamp"`
	TotalClaimed        uint64             `json:"totalClaimed"`
	TotalCashbackEarned uint64             `json:"totalCashbackEarned"`
}
...
type CreateEvent struct {
	...
	IsMayhemMode         bool               `json:"isMayhemMode"`
	IsCashbackEnabled    bool               `json:"isCashbackEnabled"`
}
...
type TradeEvent struct {
	...
	CreatorFeeBasisPoints  uint64             `json:"creatorFeeBasisPoints"`
	CreatorFee             uint64             `json:"creatorFee"`
	TrackVolume            bool               `json:"trackVolume"`
	TotalUnclaimedTokens   uint64             `json:"totalUnclaimedTokens"`
	TotalClaimedTokens     uint64             `json:"totalClaimedTokens"`
	CurrentSolVolume       uint64             `json:"currentSolVolume"`
	LastUpdateTimestamp    int64              `json:"lastUpdateTimestamp"`
	IxName                 string             `json:"ixName"`
	MayhemMode             bool               `json:"mayhemMode"`
	CashbackFeeBasisPoints uint64             `json:"cashbackFeeBasisPoints"`
...
type UserVolumeAccumulator struct {
	...
	CashbackEarned        uint64             `json:"cashbackEarned"`
	TotalCashbackClaimed  uint64             `json:"totalCashbackClaimed"`
}
